			...
			<div style={{
				...
				<img
					...
					style={{
						width: '190px',
						height: '61px',
						filter: 'drop-shadow(0 0 12px rgba(255,180,50,0.7)) hue-rotate(20deg) saturate(3) brightness(1.5) ',
						color: 'red'
					}}
				/>
			</div>

			{/* Cactus GIF in bottom right corner */}
			<div style={{
				position: 'absolute',
				bottom: '18px',
				right: '16px',
				...
				<img
					src="/assets/Theme2/cactus.png"
					alt="Butterfly"
					style={{
						width: 'clamp(40px, 8vw, 80px)',
						height: 'auto',
						filter: 'drop-shadow(0 0 10px rgba(143, 143, 143, 0.62))',
						height: '110px',
						width: '110px',
			...
			>
				...
				<div style={{ gridArea: 'header' }}>
					<TrialHeader
						...
						Heading='Bare Earth'
						SubHeading='Renewal & Hope Monitor'
