...
const RainyLessonsPanel = ({ onVideoSelect }) => {
  ...
  // Create ripple effect on click (buttons will call this)
  ...
  return (
    <div
      ...
      // onclick removed from the card per request — actions moved to buttons
      onMouseOver={(e) => {
    ...
    >
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              padding: '10px 14px',
              borderRadius: 10,
              background: 'linear-gradient(90deg,#2e6fa0,#3f86bf)',
              color: '#fff',
              border: 'none',
              cursor: 'pointer',
              boxShadow: '0 8px 18px rgba(30,80,130,0.35)',
              fontWeight: 700
            }}
          >
            Open Lessons
          ...
          <button
            ...
            style={{
              padding: '10px 14px',
              borderRadius: 10,
              background: 'linear-gradient(90deg,#5b7fc9,#3b5fa8)',
              color: '#fff',
              border: 'none',
              cursor: 'pointer',
              boxShadow: '0 8px 18px rgba(30,80,130,0.28)',
              fontWeight: 700
            }}
          >
            Take Quiz
      ...
      <style jsx>{`
        @keyframes rainFall { 0% { transform: translateY(-20px); opacity: 0; } 10% { opacity: 1; } 100% { transform: translateY(calc(100vh + 50px)); opacity: 0; } }
        @keyframes lightningFlash { 0% { opacity: 0; } 50% { opacity: 1; } 100% { opacity: 0; } }
        @keyframes rippleEffect { 0% { width: clamp(8px, 2vw, 10px); height: clamp(8px, 2vw, 10px); opacity: 1; } 100% { width: clamp(50px, 12vw, 70px); height: clamp(50px, 12vw, 70px); opacity: 0; } }
        @keyframes textRipple { 0%,100% { text-shadow: 0 0 20px rgba(70,130,180,0.7), 0 0 30px rgba(70,130,180,0.5); } 50% { text-shadow: 0 0 30px rgba(70,130,180,1), 0 0 40px rgba(70,130,180,0.7), 0 0 50px rgba(70,130,180,0.5); } }
        @keyframes iconFloat { 0%,100% { transform: translateY(0); } 50% { transform: translateY(-6px); } }
        @keyframes bookPage { 0%,100% { transform: rotateY(0deg) scale(1); } 50% { transform: rotateY(-10deg) scale(1.05); } }
        @keyframes quizPulse { 0%,100% { transform: scale(1) rotate(0deg); } 50% { transform: scale(1.1) rotate(5deg); } }
        @keyframes progressRotate { 0% { transform: rotate(0deg); } 100% { transform: rotate(360deg); } }
        @keyframes waterDrop1 { 0% { opacity: 0; transform: translateY(0) scale(0); } 50% { opacity: 1; transform: translateY(clamp(-20px, -5vw, -30px)) scale(1); } 100% { opacity: 0; transform: translateY(clamp(-40px, -10vw, -60px)) scale(0); } }
        @keyframes waterDrop2 { 0% { opacity: 0; transform: translateY(0) scale(0); } 50% { opacity: 1; transform: translateY(clamp(-15px, -4vw, -25px)) scale(1); } 100% { opacity: 0; transform: translateY(clamp(-30px, -8vw, -50px)) scale(0); } }
        @keyframes waterDrop3 { 0% { opacity: 0; transform: translateX(0) scale(0); } 50% { opacity: 1; transform: translateX(clamp(10px, 3vw, 20px)) scale(1); } 100% { opacity: 0; transform: translateX(clamp(20px, 6vw, 40px)) scale(0); } }
        @keyframes raindropBlink { 0%,100% { opacity: 1; transform: scale(1); } 50% { opacity: 0.5; transform: scale(0.9); } }
        @keyframes waveProgress { 0%,100% { transform: translateX(-30px); opacity: 0.8; } 50% { transform: translateX(0); opacity: 1; } }
        @keyframes shimmer { 0% { transform: translateX(-100%); } 100% { transform: translateX(100%); } }
        @keyframes pulse { 0%,100% { opacity: 1; transform: scale(1); } 50% { opacity: 0.6; transform: scale(1.2); } }
        @keyframes slideIn { 0% { opacity: 0; transform: translateX(-20px); } 100% { opacity: 1; transform: translateX(0); } }
        @keyframes progressFill { 0% { width: 0%; } }
        @media (max-width: 480px) {
          @keyframes rainFall { 0% { transform: translateY(-15px); opacity: 0; } 10% { opacity: 1; } 100% { transform: translateY(calc(100vh + 30px)); opacity: 0; } }
          @keyframes waterDrop1 { 0% { opacity: 0; transform: translateY(0) scale(0); } 50% { opacity: 1; transform: translateY(-15px) scale(1); } 100% { opacity: 0; transform: translateY(-30px) scale(0); } }
          @keyframes waterDrop2 { 0% { opacity: 0; transform: translateY(0) scale(0); } 50% { opacity: 1; transform: translateY(-12px) scale(1); } 100% { opacity: 0; transform: translateY(-24px) scale(0); } }
          @keyframes waterDrop3 { 0% { opacity: 0; transform: translateX(0) scale(0); } 50% { opacity: 1; transform: translateX(8px) scale(1); } 100% { opacity: 0; transform: translateX(16px) scale(0); } }
        }
        @media (min-width: 481px) and (max-width: 768px) {
          @keyframes waterDrop1 { 0% { opacity: 0; transform: translateY(0) scale(0); } 50% { opacity: 1; transform: translateY(-25px) scale(1); } 100% { opacity: 0; transform: translateY(-50px) scale(0); } }
          @keyframes waterDrop2 { 0% { opacity: 0; transform: translateY(0) scale(0); } 50% { opacity: 1; transform: translateY(-20px) scale(1); } 100% { opacity: 0; transform: translateY(-40px) scale(0); } }
          @keyframes waterDrop3 { 0% { opacity: 0; transform: translateX(0) scale(0); } 50% { opacity: 1; transform: translateX(15px) scale(1); } 100% { opacity: 0; transform: translateX(30px) scale(0); } }
        }
        @media (min-width: 1200px) {
          @keyframes waterDrop1 { 0% { opacity: 0; transform: translateY(0) scale(0); } 50% { opacity: 1; transform: translateY(-30px) scale(1); } 100% { opacity: 0; transform: translateY(-60px) scale(0); } }
          @keyframes waterDrop2 { 0% { opacity: 0; transform: translateY(0) scale(0); } 50% { opacity: 1; transform: translateY(-25px) scale(1); } 100% { opacity: 0; transform: translateY(-50px) scale(0); } }
          @keyframes waterDrop3 { 0% { opacity: 0; transform: translateX(0) scale(0); } 50% { opacity: 1; transform: translateX(20px) scale(1); } 100% { opacity: 0; transform: translateX(40px) scale(0); } }
        }
      `}</style>
    </div>
  );
...
export default RainyLessonsPanel;