...
const themes = [
    {
        id: 1,
        img: '/assets/LockedThemesImages/theme1.png',
        unlock: 'Theme 1',
    ...
    {
        id: 2,
        img: '/assets/LockedThemesImages/theme2.png',
        unlock: 'Theme 2',
    ...
    {
        id: 3,
        img: '/assets/LockedThemesImages/theme3.png',
        unlock: 'Theme 3',
    ...
    {
        id: 4,
        img: '/assets/LockedThemesImages/theme4.jpg',
        unlock: 'Theme 4',
    ...
    {
        id: 5,
        img: '/assets/LockedThemesImages/theme5.jpg',
        unlock: 'Theme 5',
        description: 'Nuclear Aftermath',
        redirectid: '6'
    },
    ...
    return (
        <div
            style={{
                ...
                position: 'relative',
                overflow: 'hidden',
                minHeight: isMobile ? '200px' : isTablet ? '240px' : '250px',
